...
image:
  ...
  alt: "Clermont Auvergne INP UCA ISIMA and OU graphic representation"
category: "experience"
status: null
from: 2019-09-02
to: 2024-12-13
...
import isima_building from "../../assets/education/isima_building.jpg";

<figure>
  <Image src={isima_building} alt="Main building of ISIMA" />
  <figcaption>Main building of ISIMA</figcaption>
</figure>
...
During the year, I also had to do a group project, I present it in another post: [TIG stack](./tig-stack/), and the end of the year ended with an internship I did at [Invivoo](./invivoo) in Paris.
...
import ou_campus from "../../assets/education/ou_campus.jpg";

<figure>
  <Image src={ou_campus} alt="Garden in front of OU's library" />
  <figcaption>University of Oklahoma "South Oval"</figcaption>
</figure>
...
During this program, I did a master's thesis entitled <a href="/pdf/MS_Thesis.pdf" title="Download my MS Thesis">"Evaluating the Impact of External Factors on the Stability of the Ethereum Network"</a>. In brief, I studied how external factors such as cyber threats, geomagnetic activity, and media coverage, have an impact on the network of this blockchain. In the end, I found that they don't have a visible impact, at least based on the time range studied of a few months and the data we collected, but that the nature and volume of cyber attacks vary between the blockchain's nodes in comparison to other servers.
