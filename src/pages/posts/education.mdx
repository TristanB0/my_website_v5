...
At the end of the year, we completed a group project I present in another post: [Q-learning](./q_learning).
...
During the year, I also had to do a project in group, I present it in another post: [TIG stack](./tig_stack/), and the end of the year ended with an internship I did at [Invivoo](./invivoo) in Paris.
