...
![IA learning](/assets/images/q_learning/ia_learning.gif "The IA at its first stages of learning.")
...
![IA not optimal](/assets/images/q_learning/ia_not_optimal_path.gif "The IA finds the exit but not via the optimal way.")
...
![IA best path](/assets/images/q_learning/ia_best_path.gif "The IA after it learned during enough time.")


We also added a gamemode where the player could solve the maze by himself and we integrated the whole through a menu.


![player mode](/assets/images/q_learning/player_mode.png "Images of the player mode with updated graphics.")
