...
<p>
			...
			<figure>
				<img src="./assets/images/q_learning/ia_learning.gif" alt="IA learning" />
			...
			<figure>
				<img src="./assets/images/q_learning/ia_not_optimal_path.gif" alt="IA not optimal" />
			...
			<figure>
				<img src="./assets/images/q_learning/ia_best_path.gif" alt="IA best path" />
				<figcaption>The IA after it learned during enough time.</figcaption>
			</figure>
			<p>We also added a gamemode where the player could solve the maze by himself and we integrated the whole through a menu.</p>
			<figure>
				<img src="./assets/images/q_learning/player_mode.png" alt="player mode" />
